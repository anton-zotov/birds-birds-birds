...
var boids = Array.from({
  length: 100
}, generateRandomBoid);
var birds = boids.map(function (boid) {
  return new bird_1.Bird(boid, 10);
});
var frameCount = 0;
function runSimulation() {
  ...
  boids.forEach(function (boid, i) {
    ...
    if (boid.isOutside(canvas.element.width, canvas.element.height)) {
      ...
      birds[i] = new bird_1.Bird(boids[i], 10);
    }
...
runSimulation();
},{"./styles.css":"src/styles.css","./bird":"src/bird.ts","./boid":"src/boid.ts","./vector":"src/vector.ts","./canvas":"src/canvas.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
